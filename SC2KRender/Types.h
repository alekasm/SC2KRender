...
#define XBLD_IS_HIGHWAY(v) (v == 0x69 || XBLD_IS_HIGHWAY_SLOPE(v) || (v >= XBLD_HIGHWAY_1 &&  v <= XBLD_HIGHWAY_CROSSOVER_6) || XBLD_IS_HIGHWAY_CORNER(v))
...
enum XBLDType
{
  ...
  XBLD_BRIDGE_COMMON_PIECE_2,
  XBLD_BRIDGE_COMMON_PIECE_3,
